...
public class CapNhatKhachHang_UI extends JPanel {
    private JTextField txtMaKH, txtTen, txtSDT, txtEmail, txtDiem;
    ...
    public CapNhatKhachHang_UI() {
        ...
        JLabel lblTieuDe = new JLabel("CẬP NHẬT THÔNG TIN KHÁCH HÀNG", SwingConstants.CENTER);
        ...
        txtMaKH = taoField(pnlForm, "Mã khách hàng (Không được sửa):");
        txtMaKH.setEditable(false);
        txtTen = taoField(pnlForm, "Tên khách hàng:");
        txtSDT = taoField(pnlForm, "Số điện thoại:");
        txtEmail = taoField(pnlForm, "Email:");
        txtDiem = taoField(pnlForm, "Điểm tích lũy:");
    ...
    public void chonKhachHangDeCapNhat(String maKH) {
